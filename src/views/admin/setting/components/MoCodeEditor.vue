...
onMounted(() => {
    ...
    if ($editor) {
        $editor.useLanguages((languages) => {
            //@ts-ignore
            languages.typescript.javascriptDefaults.addExtraLib(declareMongooseText, 'mongoose.d.ts');
            //@ts-ignore
            languages.typescript.javascriptDefaults.addExtraLib(declareResultText, 'result.d.ts');
            //@ts-ignore
            languages.typescript.javascriptDefaults.addExtraLib(
                getDeclareModelText(props.params?.modelItem),
                'model.d.ts'
            );

            //@ts-ignore
            // console.log(languages.typescript.javascriptDefaults);

            // let currentModelItem: ModelItem;
            // watchEffect(() => {
            //     const params = props.params;
            //     if (params?.modelItem && currentModelItem !== params.modelItem) {
            //         currentModelItem = params.modelItem;
            //         //@ts-ignore
            //         languages.typescript.javascriptDefaults.addExtraLib(
            //             getDeclareModelText(currentModelItem),
            //             'model.d.ts'
            //         );
            //     }
            // });
